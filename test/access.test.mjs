...
const BOARD_ROUTES = [
  ...
  ['POST',   '/api/agent/session/' + CARD + '/complete'],
  ['POST',   '/api/agent/session/' + CARD + '/setaside'],
  ['DELETE', '/api/agent/session/' + CARD + '/setaside'],
  ['POST',   '/api/agent/sessions/setaside', { ids: ['linear/RYV-84'] }],
